...
import beritaImage1 from "../assets/news7.png";
import beritaImage2 from "../assets/dirut.jpg";
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col items-center  mt-[100px]">
      ...
      <main className="bg-white rounded-lg shadow-lg mt-8 p-6 w-4/5">
        <article>
          ...
          Dirut BPDPKS Paparkan Keberhasilan Biodiesel Indonesia di Konferensi SVOC Rotterda
          </h2>
